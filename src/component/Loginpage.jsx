...
const Loginpage = () => {
  ...
  const check = ()=>{
    setloading(true)
    var logindetails = axios.post("https://loginapp-backend-vdr8.onrender.com/login",{"email":email,"password":pass})
  ...
  return (
    <div className=' relative w-full h-screen bg-black'>
      ...
      <div className='flex absolute top-10 sm:top-2 right-6 left-10 sm:left-16 md:left-42  justify-center items-center '>
